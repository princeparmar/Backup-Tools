...
var serviceConfigs = map[string]ServiceConfig{
	"gmail": {
		...
		BatchSize: 25, MaxConcurrency: 5, VaultConcurrency: 10, RateLimitPerSec: 10,
	},
	"google_drive": {
		Method: "google_drive", Bucket: satellite.ReserveBucket_Drive,
		Source: "google", ObjectType: "drive",
		BatchSize: 10, MaxConcurrency: 10, VaultConcurrency: 5, RateLimitPerSec: 15,
	},
	"google_photos": {
		Method: "google_photos", Bucket: satellite.ReserveBucket_Photos,
		Source: "google", ObjectType: "photos",
		BatchSize: 5, MaxConcurrency: 2, VaultConcurrency: 2, RateLimitPerSec: 3,
	},
	"google_calendar": {
		Method: "google_calendar", Bucket: satellite.ReserveBucket_Calendar,
		Source: "google", ObjectType: "calendar",
		BatchSize: 50, MaxConcurrency: 20, VaultConcurrency: 15, RateLimitPerSec: 25,
	},
	"google_contacts": {
